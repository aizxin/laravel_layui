        ...
        <section class="panel panel-padding">
            <form class="layui-form" style="padding: 17px;">
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea placeholder="<?php echo trans('admin/permission.placeholder.description'); ?>" name="description" class="layui-textarea" style="width: 60%"><?php echo e($per->description); ?></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
