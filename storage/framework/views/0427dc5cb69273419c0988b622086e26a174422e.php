        ...
        <form class="layui-form" id="usereditreset">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="username" lay-verify="required" autocomplete="off" placeholder="<?php echo trans('admin/user.placeholder.username'); ?>" value="{{euser.username}}" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label"><?php echo trans('admin/user.model.name'); ?></label>
                <div class="layui-input-inline">
                    <input type="text" name="name" lay-verify="required" autocomplete="off" placeholder="<?php echo trans('admin/user.placeholder.name'); ?>" value="{{euser.name}}" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
