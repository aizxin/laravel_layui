        ...
        <section class="panel panel-padding">
            <form class="layui-form" style="padding: 17px;">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select name="articleCategoryId" lay-verify="required" lay-search="">
                            <?php echo $menuPresenter->topCateList(trans('admin/article.menu'),$category); ?>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="title" lay-verify="required" autocomplete="off" placeholder="<?php echo trans('admin/article.placeholder.title'); ?>" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <button class="layui-btn" lay-submit="" lay-filter="addarticlestore"><?php echo trans('admin/setting.save'); ?></button>
